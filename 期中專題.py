...
# 存取CSV檔案
df.to_csv("C:\\Users\\jimmy\\OneDrive\\桌面\\cycu_ai2024\\output.csv", encoding='utf-8-sig')
...
print(df)
# 輸出為一個新的 CSV 檔案
df.to_csv("C:\\Users\\jimmy\\OneDrive\\桌面\\cycu_ai2024\\20240429.csv", encoding='utf-8-sig')
