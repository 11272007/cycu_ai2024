...
import pandas as pd
df = pd.read_csv('C:\\Users\\jimmy\\OneDrive\\桌面\\cycu_ai2024\\20240409\\地震活動彙整.csv', encoding='cp950')
...
# 保留2024/4/3 07:58:00 到 2024/4/9 23:59:59 的地震資料
df = df[(df['地震時間'] >= '2024-04-03 07:58:00') & (df['地震時間'] <= '2024-04-09 23:59:59')]
...
# 顯示地圖
m.save('C:\\Users\\jimmy\\OneDrive\\桌面\\cycu_ai2024\\20240409\\11272007 期中考.html')