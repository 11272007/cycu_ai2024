...
def process_day(day):
    # 網頁 URL
    base_url = "https://tisvcloud.freeway.gov.tw/history/TDCS/M05A/202403"
    ...
    for hour in range(24):
        ...
        for minute in range(0, 60, 5):
            # 建立 URL
            url = f"{base_url}{str(day).zfill(2)}/{str(hour).zfill(2)}/TDCS_M05A_202403{str(day).zfill(2)}_{str(hour).zfill(2)}{str(minute).zfill(2)}00.csv"
